    ...
    <nav class="navbar-custom">
        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <li class="hide-phone app-search">
                <form>
                    <input type="text" placeholder="Searchadmin." class="form-control">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                    ...
                    <div class="slimscroll" style="max-height: 230px;">
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon"><img src="{{ url('admin/images/users/avatar-2.jpg') }}"
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon"><img src="{{ url('admin/images/users/avatar-3.jpg') }}"
                                    class="img-fluid rounded-circle" alt="" /> </div>
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon"><img src="{{ url('admin/images/users/avatar-4.jpg') }}"
                                    class="img-fluid rounded-circle" alt="" /> </div>
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon"><img src="{{ url('admin/images/users/avatar-5.jpg') }}"
                                    class="img-fluid rounded-circle" alt="" /> </div>
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="notify-icon"><img src="{{ url('admin/images/users/avatar-6.jpg') }}"
                                    class="img-fluid rounded-circle" alt="" /> </div>
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                    aria-haspopup="false" aria-expanded="false">
                    <img src="{{ url('admin/images/users/avatar-1.jpg') }}" alt="user" class="rounded-circle"> <span
