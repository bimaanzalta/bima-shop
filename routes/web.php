...
Route::get('/books/{book}/restore', 'BookController@trash')->name('books.restore');
Route::delete('/books/{book}/delete-permanent', 'BookController@deletePermanent')->name('books.delete-permanent');
